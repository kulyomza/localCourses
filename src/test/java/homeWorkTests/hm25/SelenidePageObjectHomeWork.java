...
public class SelenidePageObjectHomeWork extends InitialSelenide {
    ...
    final String COOKIE_VALUE = "qMVG4EbmTavyakgf469R7wP.QJswWp1.pHAUShex1J8-1702129305-0-1-7a105317.4ee41f07.2d110cf7-0.2.1702129305";
    final String EXPECTED_CART_COUNTER = "1";

    @Test
    public void testAddProductToCartAndQuantity(){
        open(URL);
        rozetkaCFCookie(COOKIE_VALUE);
